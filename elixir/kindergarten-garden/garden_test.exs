...
defmodule GroupInFoursTests do
  use ExUnit.Case

  test "for RC GV should return [R,C,G,V]" do
    assert Garden.chunk_plants("RC\nGV") ==
      [{:radishes, :clover, :grass, :violets}]
  end

  test "for RRCC GGVV should return groupped result" do
    assert Garden.chunk_plants("RRCC\nGGVV") ==
      [{:radishes, :radishes, :grass, :grass}, {:clover, :clover, :violets, :violets}]
  end
end
