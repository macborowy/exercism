...
defmodule ToDecimalTests do
  use ExUnit.Case

  describe "to_decimal/2 tests" do
    test "for empty list should return 0" do
      assert Hexadecimal.to_decimal([], 0) == 0
    end

    test "for [10] should return 10" do
      assert Hexadecimal.to_decimal('A', 0) == 10
    end

    test "for [1, 10] should return 26" do
      assert Hexadecimal.to_decimal('1A', 0) == 26
    end
  end
end
