...
# defmodule SortStringTests do
#
#   use ExUnit.Case
#
#     @tag :pending
#   test "empty string result empty string" do
#     assert Anagram.sort_string("") === ""
#   end
#
#     @tag :pending
#   test "ba string after sorting should be ab string" do
#     assert Anagram.sort_string("ba") === "ab"
#   end
# end
#
# defmodule SelectValuesTests do
#
#   use ExUnit.Case
#
#     @tag :pending
#   test "when list is empty should return empty list" do
#     assert Anagram.select_values([], []) == []
#   end
#
#   test "should return candidate element at index" do
#     assert Anagram.select_values(["one"], [{"eno", 0}]) == ["one"]
#   end
#
# end
