...
defmodule GroupsLengthTests do
  use ExUnit.Case

  test "for 1 character and 4 workers should return 1" do
    assert Frequency.groups_length("a", 4) == 1
  end
end

defmodule CreateChunksTests do
  use ExUnit.Case

  test "for one character and 4 workers should return list containing list with this one character" do
    assert Frequency.create_chunks("a", 4) == [["a"]]
  end

  test "for four characters and 2 workers should return 2 lists with 2 characters" do
    assert Frequency.create_chunks("aaaa", 2) == [["a", "a"], ["a", "a"]]
  end

  test "for long string and 4 workers should return 4 chunks" do
    assert Frequency.create_chunks("Freude schöner Götterfunken Tochter aus Elysium", 4) |> Enum.count == 4
  end
end
