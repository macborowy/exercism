...
defmodule AcronymTest do
  ...
  # @tag :pending
  test "produces acronyms for diacritic letters" do
    assert Acronym.abbreviate("Inżynieria Środowiska") === "IŚ"
  end

  # @tag :pending
  test "produces acronyms for words with diacritic letters" do
    assert Acronym.abbreviate("Inżynieria ŚmiesznegoŚmieszkowania") === "IŚŚ"
  end
end

defmodule AcronymListTest do

  use ExUnit.Case

  test "returns all capital letters" do
    assert Acronym.acronym_list("InżynieriaŚrodowiska") == ["I", "Ś"]
  end
