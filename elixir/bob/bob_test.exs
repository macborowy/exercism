...
defmodule MyBobTest do

  use ExUnit.Case

  test "THIS IS YELLING is yelling" do
    assert Bob.yelling?("THIS IS YELLING") == true
  end

  test "this is not yelling is not yelling" do
    assert Bob.yelling?("this is not yelling") == false
  end

  test "This Is Also Not Yelling is not yelling" do
    assert Bob.yelling?("This Is Also Not Yelling") == false
  end

  test "Empty string is not yelling" do
    assert Bob.yelling?("") == false
  end
end
